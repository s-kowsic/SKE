...
export default function AdminAnalytics() {
  ...
  if (loading) return <div className="p-8 text-center text-xl text-gray-400">{t('admin.loadingAnalytics')}</div>;

  return (
    <div className="container mx-auto px-4 py-8">
      <div className="w-full">
        <h2 className="text-3xl font-bold mb-6">{t('admin.revenueOverview')}</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
          <div className="bg-industrial-800 p-6 rounded-lg border border-industrial-700 text-center">
            <p className="text-gray-400 mb-2">{t('admin.totalSalesRevenue')}</p>
            <p className="text-4xl font-bold text-industrial-orange">₹{analytics?.totalSales.toFixed(2) || '0.00'}</p>
          </div>
          <div className="bg-industrial-800 p-6 rounded-lg border border-industrial-700 text-center">
            <p className="text-gray-400 mb-2">{t('admin.totalOrders')}</p>
